<template>
	<div class="p-4 min-h-screen w-full">
		...
		<div class="showcase-block">
			...
			<BaseButton @click="modal1Active = true">Open modal 1</BaseButton>
			<BaseButton @click="modal2Active = true">Open modal 2</BaseButton>
			<BaseModal v-show="modal1Active" @close="modal1Active = false">
			...
			<BaseModal prevent-bg-close v-show="modal2Active" @close="modal2Active = false">
				...
				<BaseButton @click="modal2Active = false">Close</BaseButton>
			</BaseModal>
		</div>
	</div>
</template>
