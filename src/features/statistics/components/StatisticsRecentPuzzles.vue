...
<div>
	<StatisticsBlockHeading>
		...
		<template #right>
			<router-link
				class="self-center text-teal-700 dark:text-teal-300 fine:hover:text-teal-500 active:text-teal-500 dark:fine:hover:text-teal-200 dark:active:text-teal-100 flex flex-row items-center"
