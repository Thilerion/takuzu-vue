...
<style scoped>
.text-btn {
	@apply px-3 py-2 font-bold text-xs tracking-wide focus:outline-none active:ring active:ring-teal-600 active:ring-opacity-70 rounded disabled:opacity-30 text-gray-900/90 dark:text-gray-150/90 fine:hover:text-gray-900/100 fine:hover:dark:text-gray-150/100 disabled:text-gray-800 dark:disabled:text-gray-100;
	@apply fine:hover:dark:enabled:bg-white/10 fine:hover:enabled:bg-gray-500/10;
}
